...
class ComplimentGenerator:
    def __init__(self):
        ...
        self.compliment_template = [
            ...
            "Thank you!",
            "Your energy sets a fantastic example!",
            "Looking sharp today!",
            "{name}, your positive attitude is infectious!",
        ]
...
class FaceAppBackend:
    def __init__(self):
        ...
        # This line ensures the 'known_faces' directory is created automatically on the server's storage
